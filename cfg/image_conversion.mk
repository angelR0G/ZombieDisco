...
## 16 colours palette
PALETTE=0 3 4 5 6 7 8 9 11 13 15 16 17 25 26
...
# $(eval $(call IMG2SP, CONVERT, assets/nave_nodriza.png , 36, 36, spr_nave_nodriza))
# $(eval $(call IMG2SP, CONVERT, assets/nave_enemiga.png , 20, 20, spr_nave_enemiga))
# $(eval $(call IMG2SP, CONVERT, assets/nave_player.png , 12, 16, spr_nave_player))
# $(eval $(call IMG2SP, CONVERT, assets/player.png , 10, 12, spr_player))
# $(eval $(call IMG2SP, CONVERT, assets/zombie.png , 8, 16, spr_zombie))
# $(eval $(call IMG2SP, CONVERT, assets/bullet.png , 8, 8, spr_bullet))
# $(eval $(call IMG2SP, CONVERT, assets/DiscoBullet.png , 8, 9, spr_bulletdisco))
$(eval $(call IMG2SP, CONVERT, assets/DiscoZombi.png , 12, 20, spr_zombiedisco))
$(eval $(call IMG2SP, CONVERT, assets/DiscoZombi2.png , 12, 20, spr_zombiedisco2))
$(eval $(call IMG2SP, CONVERT, assets/DiscoZombi3.png , 12, 20, spr_zombiedisco3))
$(eval $(call IMG2SP, CONVERT, assets/DiscoZombi4.png , 12, 20, spr_zombiedisco4))
$(eval $(call IMG2SP, CONVERT, assets/DiscoPlayer.png , 12, 19, spr_playerdisco))
#$(eval $(call IMG2SP, CONVERT, assets/DiscoChainsaw.png , 12, 20, spr_zombiechainsaw))
$(eval $(call IMG2SP, CONVERT, assets/heart.png , 6, 6, spr_heart))
$(eval $(call IMG2SP, CONVERT, assets/emptyheart.png , 6, 6, spr_emptyheart))
$(eval $(call IMG2SP, SET_FOLDER, src/levels/))
$(eval $(call IMG2SP, SET_IMG_FORMAT, zgtiles))
$(eval $(call IMG2SP, CONVERT, assets/tileset.png, 8, 8, g_tiles))

$(eval $(call IMG2SP, SET_FOLDER, src/sprites/screens ))
$(eval $(call IMG2SP, SET_IMG_FORMAT, screen))
$(eval $(call IMG2SP, SET_OUTPUT, bin))
$(eval $(call IMG2SP, CONVERT, assets/FondoInicio2.png, 0, 0, screen_inicial))
$(eval $(call IMG2SP, CONVERT, assets/FondoControles2.png, 0, 0, screen_controles))
$(eval $(call IMG2SP, CONVERT, assets/FondoGameOver.png, 0, 0, screen_game_over))
